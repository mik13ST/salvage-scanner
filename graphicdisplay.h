...
//#endif
 ...
 private:
  ...
  class GraphicDisplay : protected U8GLIB_PCD8544 {

   public:
	GraphicDisplay(uint8_t sck, uint8_t mosi, uint8_t cs, uint8_t a0, uint8_t reset);
	void lcd_data( unsigned char Data);
	void lcd_clear( void );
	void lcd_line(unsigned char Line);
	//Clear single line of display
...
//#endif
 ...
 private:
  u8g_uint_t _column;
  u8g_uint_t _row;
  byte _symbuffer[84]; // DOGM128:21x8 chars=168, PCD8544:14x6chars=84
  u8g_uint_t _comp;
};
